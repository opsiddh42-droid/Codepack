import os
import shutil
from pdf2image import convert_from_path, pdfinfo
import pytesseract
...
def process_pdfs():
    ...
    for file in pdf_files:
        ...
        try:
            # Bina poori PDF load kiye sirf total pages check karna
            ...
            for start_page in range(1, total_pages + 1, CHUNK_SIZE):
                ...
                if not pages_to_process:
                    continue # Agar ho chuke hain toh agle chunk par jao
                    
                print(f"\n⏳ Loading Pages {start_page} to {end_page} into memory...")
                # Sirf utne hi pages load karna jitni zaroorat hai
            ...
            # Saari choti txt files ko jod kar ek badi file banana
            full_text = ""
            for i in range(total_pages):
